# this program implements a mean reversion strategy on 1m ETHUSDT futures
import pandas as pd
import numpy as np
...
current_price = price_data.iloc[-1]['close'].item()
contract_size = kucoin_main.load_markets(
)[symbol_kucoin_futures]['contractSize']
trend = chart.identify_trend_variable(price_data,23, 2)
